...
// jsPDF's built-in fonts (helvetica/times/courier) don't have a glyph for the
// ₹ symbol — it renders as a broken/stray character in exported PDFs. Use this
// "Rs." version specifically for any text that goes into a PDF.
export function fmtMoneyPdf(n) { return "Rs. " + Math.round(Number(n) || 0).toLocaleString("en-IN"); }
